...
####Part 1: Setup libraries and data

######1a. Include libraries
...
######1b. Import and format genotype and phenotype data  
...
####Part 2: Obtain P-values for genotypes under normal linear regression

######2a. P-value calculator function
...
####Part 3. PCA plots for genotype data given potential covariates
...
####Part 4. Obtain P-values for genotypes under normal linear regression with inclusion of population covariate

######4a. P-value with covariate function 
...
######4b. Get and store values in table
...
####Part 5. Compare P-values obtained with and without population covariate inclusion 

######5a. Totals of significant values
...
####Part 6. Identify causal SNPs versus SNPs that are significant due to linkage disequilibrium 
...
######6b. Identification of peak values 
...
####Part 7. Identification of SNP effect on genotype and corresponding genes
...
######7b. Biomart / Ensembl database lookup 
